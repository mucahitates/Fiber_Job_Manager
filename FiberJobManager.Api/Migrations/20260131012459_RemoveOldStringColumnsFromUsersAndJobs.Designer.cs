...
namespace FiberJobManager.Api.Migrations
{
    ...
    [Migration("20260131012459_RemoveOldStringColumnsFromUsersAndJobs")]
    partial class RemoveOldStringColumnsFromUsersAndJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FiberJobManager.Api.Models.Job", b =>
                {
                    ...
                    b.HasOne("FiberJobManager.Api.Models.Region", "Region_Nav")
                        .WithMany("Jobs")
                        .HasForeignKey("RegionId");
