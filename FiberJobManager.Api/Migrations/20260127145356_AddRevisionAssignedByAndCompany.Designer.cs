...
namespace FiberJobManager.Api.Migrations
{
    ...
    [Migration("20260127145356_AddRevisionAssignedByAndCompany")]
    partial class AddRevisionAssignedByAndCompany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FiberJobManager.Api.Models.Job", b =>
                {
                    ...
                    b.Property<int?>("RevisionAssignedByUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RevisionAssignedByUserId");
            ...
            modelBuilder.Entity("FiberJobManager.Api.Models.Job", b =>
                {
                    b.HasOne("FiberJobManager.Api.Models.User", "RevisionAssignedByUser")
                        .WithMany()
                        .HasForeignKey("RevisionAssignedByUserId");
